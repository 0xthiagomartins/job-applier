...
TARGET_JOB_ID = os.environ.get("JOB_APPLIER_TARGET_JOB_ID", "4413488167")
...
os.environ["JOB_APPLIER_OUTPUT_DIR"] = f"/tmp/job-applier-prod-targeted-{TARGET_JOB_ID}-{RUN_TOKEN}"
os.environ["JOB_APPLIER_PLAYWRIGHT_HEADLESS"] = "true"
