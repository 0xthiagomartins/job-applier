...
PLAYWRIGHT_MCP_HOST="${JOB_APPLIER_PLAYWRIGHT_MCP_HOST:-localhost}"
PLAYWRIGHT_MCP_PORT="${JOB_APPLIER_PLAYWRIGHT_MCP_PORT:-8931}"
DEFAULT_LOCAL_PLAYWRIGHT_MCP_URL="http://${PLAYWRIGHT_MCP_HOST}:${PLAYWRIGHT_MCP_PORT}/mcp"
...
if [ -n "${PLAYWRIGHT_MCP_URL}" ] && [ "${PLAYWRIGHT_MCP_URL}" != "${DEFAULT_LOCAL_PLAYWRIGHT_MCP_URL}" ]; then
  ...
  export JOB_APPLIER_PLAYWRIGHT_MCP_URL="${DEFAULT_LOCAL_PLAYWRIGHT_MCP_URL}"
